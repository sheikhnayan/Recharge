...
class InvoiceItem
{
    ...
    public function first(string $first)
    {
        $this->first = $first;
    ...
    public function last(string $last)
    {
        $this->last = $last;
    ...
    public function dob(string $dob)
    {
        $this->dob = $dob;
    ...
    public function codice(string $codice)
    {
        $this->codice = $codice;
    ...
    public function iccid(string $iccid)
    {
        $this->iccid = $iccid;
