            ...
            <div class="position-relative home_product_card">
              ...
              <div class="home_card_text">
                <div class="brand_logo d-flex">
                  <span>Poco
                  <img src="images/M3_logo.png" width="auto" height="30px"></span>
                  <img src="images/Mi-Xiaomi-Logo.png" width="auto" height="30px">
                </div>
                <div class="row">
                  <div class="col-12 model_price">
                    <h4>POCO M3- 4GB/128GB</h4>
                    <h5 class="rate_for_customer">$300.00</h5>
                ...
                <div class="row">
                  ...
                  <div class="col-12 stock_rate">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <span class="input-group-text" id="basic-addon2">Buy</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <table class="table table-sm" style="border-bottom: 1px solid #dee2e6;">
            <tbody>
              <tr>
                ...
                <td>We can not guarantee that the information on this page is 100% correct. <a href="https://www.gsmarena.com/glossary.php3?term=data-disclaimer">Read more</a></td>
              </tr>
            </tbody>
          </table>
